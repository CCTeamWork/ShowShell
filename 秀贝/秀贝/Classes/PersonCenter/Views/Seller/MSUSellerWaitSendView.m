...
@interface MSUSellerWaitSendView ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation MSUSellerWaitSendView
...
- (void)createView{
    self.addressStr = @"浙江省杭州市杭州市江干区江干区迪凯银座1301市";
    self.aa = [MSUStringTools danamicGetHeightFromText:_addressStr WithWidth:SelfWidth-20-10-70-10 font:14];
    NSLog(@"----%f",_aa.size.height);
    
    self.wordsStr = @"我还是喜欢你，像风吹三千里，不问归期;我还是喜欢你，像花开了又谢，天真无邪！";
    self.bb = [MSUStringTools danamicGetHeightFromText:_wordsStr WithWidth:SelfWidth-20-40-10-10 font:14];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.wordsLab.frame = CGRectMake(10+10+35, CGRectGetMaxY(cell.addressContentLab.frame)+5, SelfWidth-20-40-10-10, _bb.size.height);
