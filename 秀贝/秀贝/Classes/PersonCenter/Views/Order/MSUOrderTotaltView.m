...
@interface MSUOrderTotaltView ()<UITableViewDelegate,UITableViewDataSource>

@property (nonatomic , strong) UITableView *tableView;

@end

@implementation MSUOrderTotaltView
...
- (void)createView{
    ...
    [_tableView registerClass:[MSUOrderTableCell class] forCellReuseIdentifier:@"orderTotalCell"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    MSUOrderTableCell *cell = [tableView dequeueReusableCellWithIdentifier:@"orderTotalCell"];
    cell.selectionStyle = UITableViewCellSeparatorStyleNone;
    cell.backgroundColor = [UIColor clearColor];
    
    cell.nickLab.text = @"叶叶叶叶叶子";
    cell.statusLab.text = @"等待付款等待付款";
